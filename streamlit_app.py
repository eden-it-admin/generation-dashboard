...
st.write("This is an UAT dashboard for Eden Renewables India LLP Generation files for all Plants and their SPV, and we have currently displayed the BAP and UTT Plants and their SPV.")
st.write("We are working on adding Other Plant and their SPV, and it will be available soon...")
